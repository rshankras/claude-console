namespace Loupedeck.ClaudeConsolePlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.ClaudeConsolePlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.ClaudeConsolePlugin.Resources.Resource.txt`.
