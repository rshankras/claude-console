...
PLACE = {
    ...
    (0, 4): ("AnswerCommand___no", "VoiceCommand"),
    (0, 5): ("AnswerCommand___yes", "VoiceDraftCommand"),
    (0, 7): (None, "AnswerCommand___no"),
    (0, 8): ("VoiceCommand", "AnswerCommand___yes"),
    ...
    (1, 3): ("AnswerCommand___up", "ControlCommand___agent"),
    (1, 4): ("AnswerCommand___enter", "ControlCommand___fork"),
    (1, 5): ("AnswerCommand___down", "ControlCommand___resume"),
    (1, 6): ("ScrollCommand___scroll_up", "ControlCommand___review"),
    (1, 7): ("ScrollCommand___scroll_down", "ContextCommand"),
    (1, 8): (None, "ControlCommand___compact"),
    ...
    (3, 6): (None, "AnswerCommand___up"),
    (3, 7): (None, "AnswerCommand___enter"),
    (3, 8): (None, "AnswerCommand___down"),
