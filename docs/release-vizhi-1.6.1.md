...
**Release source: main `9b7595a`** (the merge of #104).

## Done

| Item | Evidence |
|---|---|
| Code on main, both products versioned | `9b7595a`; Vizhi 1.6.1, Claude Console 2.2.3 |
| macOS suite | 1,191 passed, 0 failed, 13 skipped (Windows-only hook tests) |
| Windows suite | 1,204 passed, 0 failed, 0 skipped at `8467c48`; runtime unchanged through `9b7595a` |
| Both Release builds | 0 warnings, 0 errors, both platforms |
| Package built | `VizhiCodex_1.6.1.lplug4`, sha `ef35c7d765ea…`, 16.60 MiB |
...
| Profile | Five pages, three session keys, revision `2026-09-16.2`; verified against the installed layout on Windows |
| Licence + URLs | Proprietary, EULA and support and homepage all on vizhi.dev; no user-facing github.com link |
| Listing copy | Teaser 104/120, detail 470/500, release notes 986/1000; reviewer notes written |

## Open — owner

- [ ] **Listing screenshots / artwork.** The Marketplace page needs them and none exist for this
      product. Blocks submission.
...
- [ ] **Confirm the EULA on vizhi.dev carries the same §1 grant as `EULA.md`.** The site copy still
      said MIT on 2026-09-09; the package now points every user at that URL.
